...
const perform = async (z, bundle) => {
  const data = await requestAction(z, 'move_task_to_section', {
    ...
    // section_id: bundle.inputData.section_id,   // TODO: sections dropdown resource nahi bana abhi, plain text hai
  });
...
module.exports = {
  ...
  operation: {
    inputFields: [
      ...
      // { key: 'section_id', label: 'Section ID', type: 'string', required: true },  // TODO: dropdown baad mein
    ],
    perform,
